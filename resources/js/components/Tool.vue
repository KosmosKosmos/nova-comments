<template>
    <div>
        <h4 class="text-90 font-normal text-2xl mb-3">Comments</h4>

        <div class="card mb-6 overflow-hidden">
            <div class="flex border-b border-40 remove-bottom-border px-8">
                <div class="w-full pt-6 pb-2">
                    <h4 class="font-normal text-80">Write new comment</h4>
            ...
            <div class="flex justify-between px-8 pb-4 border-b border-40">
                <div class="help-text">On MacOS, press ⌘ + Enter to save</div>
